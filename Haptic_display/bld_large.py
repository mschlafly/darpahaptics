...
def draw_bld_large(x,y,W_building_tablet,H_building_tablet,x_max,y_max,im):

    band1_black = round(.08 * .5 * H_building_tablet);
    band1_darkgrey = round(.025 * .5 * H_building_tablet);
    band1_grey = round(.025 * .5 * H_building_tablet);
    band1_white = round(.08 * .5 * H_building_tablet);

    band2_black = round(.07 * .5 * H_building_tablet);
    band2_darkgrey = round(.02 * .5 * H_building_tablet);
    band2_grey = round(.02 * .5 * H_building_tablet);
    band2_white = round(.07 * .5 * H_building_tablet);

    band3_black = round(.05 * .5 * H_building_tablet);
    band3_darkgrey = round(.015 * .5 * H_building_tablet);
    band3_grey = round(.015 * .5 * H_building_tablet);
    band3_white = round(.075 * .5 * H_building_tablet);
    ...
    y_inner = y_inner+band3_grey+band3_white;
...
name = 'HelloTanvas/Assets/bld_large';

x=0;
y=0;
draw_bld_large(x,y,W_building_tablet,H_building_tablet,H_building_tablet,H_building_tablet,im)
