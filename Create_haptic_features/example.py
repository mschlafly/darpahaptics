...
# example number 1 for the person at (7,14,0) 10 building zoom
# example number 2 for the person at (23,11,0) 10 building zoom
examplenum = 2;
...
if (examplenum == 1):
    ...
    building_x=(-62,250,718,1030,718,-62,718,1030);
    building_y=(-78,-78,-78,-78,234,702,702,702);
    ...
    for y in range(-100,H_tablet,1):
        ...
        for i in range(num_buildings):
            ...
            if (building_x[i] == x) and (building_y[i] == y):
                ...
                if (examplenum == 2):
                    draw_bushes(406,-78,xmax,ymax,W_building_tablet,H_building_tablet,im)
                    draw_bushes(718,390,xmax,ymax,W_building_tablet,H_building_tablet,im)
    ...
    for y in range(-100,H_tablet,1):
        for i in range(num_buildings):
            if (building_x[i] == x) and (building_y[i] == y):
                ...
                if (examplenum == 2):
                    draw_bushes(250,702,xmax,ymax,W_building_tablet,H_building_tablet,im)
                    draw_bushes(250,234,xmax,ymax,W_building_tablet,H_building_tablet,im)
...
if (examplenum == 1):
    im.save(name+'/TouchDetection/training/training/Assets/example1.png');
elif (examplenum == 2):
    im.save(name+'/TouchDetection/training/training/Assets/example2.png');
